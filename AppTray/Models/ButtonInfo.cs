...
namespace AppTray.Models
{
    public class ButtonInfo : IEnumerable<KeyValuePair<int, AppInfo>>
    {
        ...
        public Dictionary<int, Dictionary<int, AppInfo>> Load(string directory)
        {
            ...
            var buttonInfos = JsonConvert.DeserializeObject<Dictionary<int, Dictionary<int, AppInfo>>>(File.ReadAllText(settingFile, Encoding.UTF8), new JsonSerializerSettings() { TypeNameHandling = TypeNameHandling.Objects });
