...
namespace AppTray.Views.Converters {
    public class ImageSourceMultiBindConverter : MarkupExtension, IMultiValueConverter {
        ...
        private static ImageSourceMultiBindConverter _converter;

        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            return _converter ?? (_converter = new ImageSourceMultiBindConverter());
        }
    }
}
